...
const Doctors = () => {
  ...
  <path fill-rule="evenodd" d="M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z"/>
                ...
                <div className="names">
                    ...
                    <button className="status" onClick={(v) => setStatus(false)}>
                    </button>
                    <button className="status" onClick={(v) => setStatus(true)}>
                    </button>

                    {status === true ?
                        <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" fill="green" class="bi bi-circle-fill" viewBox="0 0 16 16" style={{ paddingTop: "-10%" }}>
                            <circle cx="8" cy="8" r="8" />
                        </svg>
                        :
                        <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" fill="red" class="bi bi-circle-fill" viewBox="0 0 16 16" style={{ paddingTop: "-10%" }}>
                            <circle cx="8" cy="8" r="8" />
                        </svg>
                    }
